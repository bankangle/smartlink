...
<svelte:head><title>Sign in · Coasthill IV</title></svelte:head>
...
<div class="relative flex min-h-[100dvh] items-center justify-center overflow-hidden bg-[#08090a] px-5 text-[#f7f8f8]">
  ...
  <div class="relative w-full max-w-sm">
    <div class="mb-7 text-center">
      ...
      <p class="mt-1.5 text-sm text-white/45">Manage your smart links and analytics.</p>
    </div>
    ...
    <p class="mt-4 text-center text-sm text-white/40">
      New artist?
      <a href="/admin/register" class="font-medium text-white/75 underline-offset-2 transition hover:text-white hover:underline">Create an account</a>
    </p>
    <p class="mt-2 text-center font-mono text-[11px] text-white/25">demo · admin / changeme</p>
  </div>
</div>
